...
$sql = "UPDATE fr_persons SET filetype = '$fileType', filesize = '$fileSize', content = '$content',filename = '$fileName',description = '$fileDescription' WHERE email = '$email'";
...
// print out Image files from the database
foreach ($pdo->query($sql) as $row) {
    $id = $row['id'];
    $sql = "SELECT * FROM fr_persons where id=$id"; 
